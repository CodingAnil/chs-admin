...
import AddMoreIcon from "@/icon/add-more.svg";
import MediaVerificationModal from "@/components/modals/verify-modal";
...
const UploadProfilePhotos = () => {
  ...
  return (
    <div className="block">
      <div className="block">
        <h4 className="mb-2 text-lg text-darkWhite">Upload Photos</h4>
