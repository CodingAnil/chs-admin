...
import { SidebarMenu } from "../../../utils/routes/DashboardRoutes";
  ...
  return (
    <Fragment>
      <SimpleBar style={{ maxHeight: "100vh" }}>
        <div className="nav-scroller custom-navbar">
          <Link href="/" className="navbar-brand">
            <Image src="/images/logo/brand-logo-lg.png" alt="" />
          </Link>
        </div>
        {/* Dashboard Menu */}
        <Accordion
        ...
        >
          {SidebarMenu.map(function (menu, index) {
            if (menu.grouptitle) {
              return (
