...
const MediaVerificationModal = ({
  ...
  return (
    <Modal
      ...
      placement="center"
    >
      <ModalContent className="bg-secondaryShade1 backdrop-blur-lg max-w-[95%] md:max-w-[900px] rounded-md md:rounded-[20px] border border-secondaryShade3 p-8 md:p-10 font-primary">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            {verifyType && (
              <div className="border flex-1 flex items-center justify-center border-dashed bg-[#FFFFFF1A] border-darkGrey400 rounded-[12px] h-[250px] w-full md:w-auto relative">
                ...
                {govIdImage ? (
                  <>
                    <label className="cursor-pointer relative flex flex-col items-center justify-center w-full h-[300px] md:h-full p-4">
                      <Image
                        width={70}
                        height={70}
                        src={govIdImage}
            ...
            <div className="border flex-1 flex items-center justify-center border-dashed bg-[#FFFFFF1A] border-darkGrey400 rounded-[12px] h-[250px] w-full md:w-auto relative">
              ...
              {selfieImage ? (
                ...
                <>
                  <label
                    htmlFor="selfieInput"
                    className="cursor-pointer relative flex flex-col items-center justify-center w-full h-[300px] md:h-full p-4"
                  >
                    <div className="text-center flex justify-center mb-[15px]">
                      <UploadIcon />
                    </div>
...
export default MediaVerificationModal;
